...
public struct PairingKeys: @unchecked Sendable {
    ...
    public enum Info {
        public static let auth = "kidscam/v1/auth"
        public static let signaling = "kidscam/v1/sig"
        public static let event = "kidscam/v1/event"
        public static let sas = "kidscam/v1/sas"
    }
