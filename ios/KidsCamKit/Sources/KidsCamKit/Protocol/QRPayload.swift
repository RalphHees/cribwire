...
///
/// ```
/// kidscam://pair?v=1&id=<pairingId>&s=<S>&api=<url>
/// ```
///
...
public struct QRPayload: Sendable {
    ...
    public static let scheme = "kidscam"
    ...
    public enum ParseError: Error, Equatable, Sendable {
        /// Not a `kidscam://pair` URL at all — most likely an unrelated QR code.
        case notAPairingURL
    ...
    /// vector in `shared/test-vectors/kidscam-v1.json` exactly.
    ...
    /// `https%3A%2F%2Fapi.kidscam.example` in the shared vector.
