...
/// Typed view of `shared/test-vectors/cribwire-v1.json` (revision 1.1).
///
/// The file is *not* copied into this target — `Resources/cribwire-v1.json` is a
...
struct TestVectors: Decodable {
    ...
    static let resourceName = "cribwire-v1"
    ...
    static func load(file: StaticString = #filePath, line: UInt = #line) throws -> TestVectors {
        ...
        XCTFail(
            "Could not read shared/test-vectors/cribwire-v1.json from the test bundle "
                + "or the source tree",
            file: file,
            line: line
        )
