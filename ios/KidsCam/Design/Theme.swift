...
/// The KidsCam design language, transcribed from `docs/design/app-screens.html`.
///
...
enum Theme {
    ...
    enum Typography {
        ...
        static let headline = Font.system(size: 21, weight: .bold)
        static let body = Font.system(size: 15)
        static let callout = Font.system(size: 14.5)
